            ...
            <div className="px-16 my-8">
              <div className="bg-gray-200 h-fit rounded-2xl p-4">
                <div className=" border-b  py-2 bg-gray-300 rounded-xl p-4 mb-4">
                  <p className="text-xl text-gray-500 py-2 ">Proposal Title</p>
                ...
                <div className=" py-2 bg-gray-300 rounded-xl p-4 mb-4">
                  ...
                  <p className="text-xl py-2">{parseInt(proposalData?.id)}</p>
                </div>
                    ...
                    {isHolder && isHolder ? (
                      ...
                      <div className="py-4 bg-gray-300 rounded-xl p-4 mb-4">
                        ...
                        <p className="text-gray-800 py-4 my-4 text-xl ">
                          If you wish to become a stakeholder for this DAO, you
                          have to buy NFT. For this you have to pay stake price
                          0.001 ETH. After purchasing NFT you have rights to
                          Vote in this DAO.
                        </p>
                        <div className=" gap-4">
